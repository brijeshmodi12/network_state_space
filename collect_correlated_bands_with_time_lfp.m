% ===================================================================
% Get Oscillators correlation time frames LFP and do UMAP
...
% Root Path - 
	...
	for animal_iterator = 1:total_folders
		...
		% -------------------------------------------------------------------	
			...
			title(sprintf('All Sleep Status Overlay on LFP CorrMat over time',animal_id))
			pbaspect([1 1 1])
			legend('Sleep')



			fname = sprintf('All_sleep_status_overlay_lfp_corr_mat_across_trials_raw.png', animal_id);
			...
			title(sprintf('All LFP CorrMat over time',animal_id))
			pbaspect([1 1 1])

			fname = sprintf('All_lfp_corr_mat_across_trials_raw.png', animal_id);
			csd_filepath = fullfile(output_folder, fname);
			saveas(gcf, csd_filepath);
			...
			suptitle(sprintf('All REM and NonREM overlay on LFP CorrMat over time',animal_id))

			fname = sprintf('All_lfp_corr_mat_across_trials.png', animal_id);
